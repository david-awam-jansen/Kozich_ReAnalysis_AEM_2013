...
```
This is our attempt to reproducice thework by Kozt et al that used the mouse data of 
Schloss et al [@Schloss2012].
 ...
 **Scaling up.** The advantage of the dual-index approach is that a large
    ...
    Titanium platform [@You2005]. In that study, we observed a clear separation
